 ...
 * @author - zk@WolfDefi
 * @notice - Provided an EIP712 compliant signed message & token claim, distributes IDT tokens 
 **/

/**
* @notice interface for interacting with IDTToken delegate function
*/
interface IDTErc20 {
...
contract TokenDistributor{ 
    ...
    bytes32 constant IDT_TOKEN_CLAIM_TYPEHASH = keccak256(
    ...
    */
    function _delegateTokens(address delegator, address delegatee) private {
         IDTErc20  IDTToken = IDTErc20(token);
         IDTToken.delegateOnDist(delegator, delegatee);
    } 
}